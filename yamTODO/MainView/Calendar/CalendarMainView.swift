...
struct CalendarMainView: View {
    ...
    @ObservedObject var today: TaskList
    ...
    var portraitCalendarView: some View {
        ZStack {
            VStack {
                CalendarView(userColor: userColor, monthDataList: monthDataList, taskList: taskList, today: today, selectedMonth: $selectedCalendar.selectedMonth, selectedDate: $selectedCalendar.selectedDate)
